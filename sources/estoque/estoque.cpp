...
void Estoque::addItemEstoque (int codigo, double preco,  std::string fornecedor, std::string descricao, int dia, int mes, int ano, int duracao){
    Item *item = new Item(codigo, preco, fornecedor, descricao, dia, mes, ano, duracao);
    addItem(*item);
}
...
Estoque::Estoque(int codigo, double preco,  std::string fornecedor,  std::string descricao, int dia, int mes, int ano, int duracao) {
